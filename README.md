...
```
hazelcast/SharedDataProvider$ java -jar target/asyncPutVerticle.jar "<fichier des membres>" "<interface>" "<fichier des clés>" -cluster

hazelcast/SharedDataReader$ java -jar target/asyncReaderVerticle.jar "<fichier des membres>" "<interface>" "<fichier des clés>" -cluster
```
...
Les clés doivent être une par ligne.
